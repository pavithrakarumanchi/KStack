...
const Login = () => {
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            //console.log(response); //response will contain user and token
            //When user is successfully logged in user will be redirected to home page
    ...
    return (
        <Layout>
            <div className="col-md-6 offset-md-3">
                ...
                {loginForm()}
                <Link href="/auth/password/forgot"><a className="text-danger float-right">Forgot Password</a></Link>
            </div>
        </Layout>
    );
};
