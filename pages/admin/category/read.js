    ...
    const listCategories = () =>
        categories.map((c, i) => (
            <Link key={i} href={`/links/${c.slug}`}>
                <a style={{ border: '1px solid black' , borderRadius: '20px' }} className="bg-light p-3 mr-2 mb-2 col-md-6">
                    <div>
                        <div className="row">
                            ...
                            <div className="col-md-3">
                                <Link href={`/admin/category/${c.slug}`}>
                                    <button className="btn btn-sm btn-success btn-block mb-1">Update</button>
                                </Link>
