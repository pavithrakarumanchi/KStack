        ...
        allLinks.map((l, i) => (
            <div key={i} className="row alert alert-primary p-2">
                ...
                <div className="col-md-12">
                    ...
                    <button onClick={e => confirmDelete(e, l._id)} className="badge text-danger pull-right ml-2 mr-2">
                        Delete
                    </button>
                    <Link href={`/user/link/${l._id}`}>
                        <a>
                            <button className="badge text-success pull-right">Update</button>
                        </a>
                    </Link>
                </div>
            </div>
